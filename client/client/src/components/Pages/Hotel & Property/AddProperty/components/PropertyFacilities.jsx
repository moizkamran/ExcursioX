    ...
    <>
      <Flex gap={50} p={20}>
            ...
            <Flex direction={'column'}>
              ...
              >
                ...
                {isBreakfastAvailable === "Yes, Its optional" && (
                  <div>
                    <Text>
                      Price for breakfast (per person, per day, <br /> including
                      all fees and taxes)
                    </Text>
                    <TextInput
                      variant="unstyled"
          ...
          <Flex direction={'column'}>
            ...
            <Text mt={10} w={550} c={'dimmed'}>Write an attention-grabbing headline and provide clear, accurate information about location, amenities, and room details. Use descriptive language to highlight unique features and mention any special offers. Proofread your description for accuracy and clarity.</Text>
          </Flex>
